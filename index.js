...
Templates.prototype.data = function (key, val) {
...
Templates.prototype.viewType = function(plural, types) {
...
Templates.prototype.find = function (name, collection) {
...
Templates.prototype.getView = function(collection, key, fn) {
...
Templates.prototype.getViews = function(name) {
  var orig = name;
...
Templates.prototype.matchView = function(collection, pattern, options) {
  var views = this.getViews(collection);
...
Templates.prototype.matchViews = function(collection, pattern, options) {
  var views = this.getViews(collection);
...
Templates.prototype.Router = utils.router.Router;
Templates.prototype.Route = utils.router.Route;
...
Templates.prototype.lazyRouter = function(methods) {
...
Templates.prototype.handle = function (method, view, locals, cb) {
...
Templates.prototype.handleView = function (method, view, locals/*, cb*/) {
...
Templates.prototype.handleError = function(method, view, cb) {
...
Templates.prototype.route = function(path) {
  this.lazyRouter();
...
Templates.prototype.all = function(path/*, callback*/) {
...
Templates.prototype.param = function(name/*, fn*/) {
  this.lazyRouter();
...
Templates.prototype.engine = function(exts, fn, settings) {
...
Templates.prototype.setEngine = function(ext, fn, settings) {
...
Templates.prototype.getEngine = function(ext) {
...
Templates.prototype.applyLayout = function(view) {
...
Templates.prototype.compile = function(view, locals, isAsync) {
...
Templates.prototype.render = function (view, locals, cb) {
  if (typeof locals === 'function') {
    cb = locals;
    locals = {};
  }
...
Templates.prototype.context = function (view, ctx, locals) {
  var obj = {};
...
Templates.prototype.bindHelpers = function (view, locals, context, isAsync) {
  var helpers = {};
...
Templates.prototype.handler = function (methods) {
...
Templates.prototype.handlers = function (methods) {
...
Templates.prototype.error = function(method, id, msg) {
...
Templates.prototype.rethrow = function(method, err, view, context) {
  try {
