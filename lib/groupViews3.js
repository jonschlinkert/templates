...
function Groups(views, listViews) {
  if (!(this instanceof Groups)) {
    return new Groups(views, listViews);
  }
...
Groups.prototype.init = function(views, listViews) {
  debug('initializing');
  var opts = {};
...
Groups.prototype.groupBy = function() {
  return this.views.groupBy.apply(this.views, arguments);
};

Groups.prototype.create = function(name, props, options) {
