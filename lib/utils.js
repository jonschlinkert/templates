...
utils.viewFactory = function (app, method, CtorName) {
  app.define(method, function(key, value) {
    ...
    var View = this.get(CtorName);
    var view = !(value instanceof View)
      ? new View(value)
      : value;

    view.options = view.options || value.options || {};
    view.locals = view.locals || value.locals || {};
    view.data = view.data || value.data || {};
