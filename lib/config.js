...
const config = {
  defaults: {
    ...
    kind: {
      ...
      value: 'renderable',
      description: 'When registering a collection, the "kind" option describes how the files in the collection will be used. This value helps the engine understand what to do with the files during the render cycle.'
    },
    layoutHistory: {
      type: 'boolean',
      valid: val => typeof val === 'boolean',
