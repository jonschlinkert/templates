...
Collection.prototype.init = function(opts) {
  ...
  this.define('List', opts.List || Collection.List);
  this.define('Groups', opts.Groups || Collection.Groups);
...
Collection.prototype.addGroup = function(group, options) {
  group = this.Groups.decorate(group, this.List);
...
utils.define(Collection, 'List', require('./list'));
utils.define(Collection, 'Groups', require('./groups'));
