...
module.exports = function(app) {
  ...
  app.define('bindHelpers', function(view, locals, context, isAsync) {
    ...
    context.helpers = utils.bindAll(helpers, thisArg, {
      bindFn: function(thisArg, key, options) {
        ...
        deprecated(thisArg.context, 'view', view, key);
        return thisArg;
      }
    });
  });
  ...
  function setHelperOptions(context, key) {
    ...
    var helperOpts = context.helper.options || {};
  ...
  function Context(app, view, locals, context, helpers) {
    ...
    this.context.view = view; // backward compatibility
    this.options = utils.merge({}, options, this.helper.options);
  ...
  function deprecated(obj, prop, val, key) {
    utils.define(obj, prop, {
      set: function(v) {
        val = v;
      },
      get: function() {
        console.log('helper %s: "this.context.view" is deprecated, use "this.view" instead', key);
        return val;
      }
    });
  }
