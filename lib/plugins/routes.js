...
module.exports = function(proto) {
  ...
  proto.handle = function(method, view, locals, cb) {
    this.debug.routes('handling method "%s", for view "%s"', method, view.key);
    ...
    var done = this.handleError(method, view, cb);
  ...
  proto.handleView = function() {
    console.log('.handleView is deprecated, use .handleOnce instead.');
