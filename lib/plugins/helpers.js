...
module.exports = function initHelpers(app) {
  ...
  app.define('helper', function(name) {
    this.debug.helpers('registering sync helper "%s"', name);
  ...
  app.define('getHelper', function(name) {
    this.debug.helpers('getting sync helper "%s"', name);
  ...
  app.define('asyncHelper', function(name) {
    this.debug.helpers('registering async helper "%s"', name);
  ...
  app.define('helperGroup', function(name, helpers, isAsync) {
    this.debug.helpers('registering helper group "%s"', name);
