...
module.exports = function (proto) {
  ...
  proto.compile = function(view, locals, isAsync) {
    ...
    locals.settings = utils.extend({}, locals.settings, engine.options);
  ...
  proto.render = function (view, locals, cb) {
    ...
    view.locals = utils.extend({}, view.locals, locals);
    view.locals = utils.extend({}, this.cache.data, view.locals);
    ...
    var ctx = utils.extend({}, view.locals, locals);
