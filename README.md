...
### [.data](lib/plugins/context.js#L31)
...
### [.context](lib/plugins/context.js#L59)
...
### [.mergePartialsSync](lib/plugins/context.js#L118)
...
### [.mergePartials](lib/plugins/context.js#L156)
...
### [.groupBy](lib/list.js#L394)

Group all list `items` using the given property, properties or compare functions. See [group-array](https://github.com/doowb/doowb/group-array) for the full range of available features and options.
...
### [.sortBy](lib/list.js#L420)

Sort all list `items` using the given property, properties or compare functions. See [array-sort](https://github.com/jonschlinkert/jonschlinkert/array-sort) for the full range of available features and options.
...
### [.paginate](lib/list.js#L468)

Paginate all `items` in the list with the given options, See [paginationator](https://github.com/doowb/doowb/paginationator) for the full range of available features and options.
...
### [.render](lib/plugins/render.js#L233)
...
### [.route](lib/plugins/routes.js#L145)
...
### [.all](lib/plugins/routes.js#L167)
...
### [.param](lib/plugins/routes.js#L196)
